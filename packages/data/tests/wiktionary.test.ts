...
test("wiktionary: source adapter exists", async () => {
  // TODO: Import and verify the Wiktionary source adapter
...
test("wiktionary: loads source data", async () => {
  // TODO: Verify source data exists and is accessible
  expect(true).toBe(true);
});

test("wiktionary: parses and emits entries", async () => {
